...
class Alg_WC_MSRP_Settings_Section {
	...
	function __construct() {
		add_filter(
			'woocommerce_get_sections_alg_wc_msrp',
			array( $this, 'settings_section' )
		);
		add_filter(
			'woocommerce_get_settings_alg_wc_msrp_' . $this->id,
	...
	function message_replaced_values( $values ) {
		$message_template = (
			...
			__( 'Replaced value: %s.', 'msrp-for-woocommerce' ) :
			/* Translators: %s: Placeholder name list. */
			__( 'Replaced values: %s.', 'msrp-for-woocommerce' )
		);
		return sprintf(
			$message_template,
		...
		return array(
			array(
				'title'             => sprintf(
					...
					__( '%s Display Options', 'msrp-for-woocommerce' ),
					$section_title
				),
				'type'              => 'title',
			...
			array(
				...
				'desc'              => (
					sprintf(
						/* Translators: %s: Placeholder name. */
						__( 'Savings amount. To display this, use %s in "Final Template"', 'msrp-for-woocommerce' ),
						'<code>' . '%you_save%' . '</code>'
					) . ' ' .
			...
			array(
				'desc'              => (
					sprintf(
						/* Translators: %s: Placeholder name. */
						__( 'Savings amount in percent. To display this, use %s in "Final Template"', 'msrp-for-woocommerce' ),
						'<code>' . '%you_save_percent%' . '</code>'
					) . ' ' .
			...
			array(
				...
				'desc'              => (
					$this->message_replaced_values( array(
						'%msrp%',
						'%you_save%',
						'%you_save_percent%',
						'%price%',
					...
					apply_filters(
						...
						sprintf(
							'<br>' . 'You will need %s plugin to change the template.',
